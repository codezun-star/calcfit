...
> **Total: 99 calculadoras** | Ver también: [CLAUDE.md](CLAUDE.md)

## Archivos de detalle

| Categoría | Archivo | Calculadoras |
|---|---|---|
| Fitness & salud | [CALCULADORAS-FITNESS.md](CALCULADORAS-FITNESS.md) | 51 |
| Nutrición & bienestar | [CALCULADORAS-NUTRICION.md](CALCULADORAS-NUTRICION.md) | 20 |
| Embarazo & fertilidad | [CALCULADORAS-EMBARAZO.md](CALCULADORAS-EMBARAZO.md) | 20 |
| Fechas & tiempo | [CALCULADORAS-FECHAS.md](CALCULADORAS-FECHAS.md) | 8 |
