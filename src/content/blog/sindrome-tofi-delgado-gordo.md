...
fecha: "2026-06-07"
keywords:
  - "síndrome TOFI peso normal grasa visceral"
  - "delgado pero con grasa visceral"
  - "obesidad metabólica peso normal"
  - "IMC normal pero malo metabólicamente"
  - "grasa visceral sin sobrepeso"
  - "peso normal pero con barriga"
...
publicado: true
unsplashQuery: "health checkup body composition medical normal weight"
---
...
| Marcador | Valor normal | Riesgo en TOFI |
|---|---|---|
| Triglicéridos en ayunas | < 150 mg/dL | Elevados (> 150-200 mg/dL) |
| HDL colesterol | > 50 mg/dL (mujer) / > 40 (hombre) | Reducido |
| Glucosa en ayunas | < 100 mg/dL | Elevada (100-125: prediabetes) |
| Circunferencia de cintura | < 80 cm (mujer) / < 94 cm (hombre) | Elevada incluso con peso normal |
| ALT (transaminasa hepática) | < 35-40 U/L | Elevada (hígado graso) |
| Proteína C reactiva ultrasensible | < 1 mg/L | Elevada (inflamación sistémica) |
| Presión arterial | < 120/80 mmHg | Elevada o límite |
...
- [Las limitaciones del IMC que el médico no siempre explica](/blog/imc-limitaciones-que-el-medico-no-explica)
- [Grasa corporal vs peso en báscula: por qué el número que ves no es lo que importa](/blog/grasa-corporal-vs-peso-en-bascula)
- [Cómo eliminar la grasa abdominal: lo que dice la ciencia](/blog/grasa-abdominal)
